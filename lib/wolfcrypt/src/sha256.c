...
/* fips wrapper calls, user can call direct */
    ...
    /* wc_port.c includes port/arm/cryptoCellHash.c */
...
#define XTRANSFORM_LEN(...) inline_XTRANSFORM_LEN(__VA_ARGS__)
    ...
    /* functions defined in port/caam/caam_sha256.c */

#elif defined(WOLFSSL_AFALG_HASH)
    /* implemented in port/af_alg/afalg_hash.c */

#elif defined(WOLFSSL_DEVCRYPTO_HASH)
    /* implemented in port/devcrypto/devcrypt_hash.c */
    ...
    /* implemented in port/Renesas/renesas_tsip_sha.c */

#elif defined(WOLFSSL_PSOC6_CRYPTO)

    /* implemented in port/cypress/psoc6_crypto.c */

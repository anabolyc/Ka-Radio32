...
/* Define AES implementation includes and functions */
    ...
    /* implemented in port/af_alg/afalg_aes.c */

#elif defined(WOLFSSL_DEVCRYPTO_AES)
    /* implemented in port/devcrypto/devcrypto_aes.c */
...
/* wc_AesSetKey */
...
#elif defined(WOLFSSL_IMX6_CAAM) && !defined(NO_IMX6_CAAM_AES)
      /* implemented in port/caam/caam_aes.c */
    ...
    /* implemented in port/silabs/silabs_hash.c */
    ...
    #ifdef WOLFSSL_IMXRT_DCP
        /* Implemented in port/nxp/dcp_port.c */
        temp = 0;
        if (keylen == 16)
...
/* AES-DIRECT */
    ...
    #elif defined(WOLFSSL_DEVCRYPTO_AES)
        /* implemented in port/devcrypt/devcrypto_aes.c */
...
static WC_INLINE void IncCtr(byte* ctr, word32 ctrSz)
{
    ...
    /* implementation is located in port/arm/armv8-aes.c */

#elif defined(WOLFSSL_AFALG)
    /* implemented in port/afalg/afalg_aes.c */
...
#ifdef WOLFSSL_ARMASM
    /* implementation located in port/arm/armv8-aes.c */

#elif defined(HAVE_COLDFIRE_SEC)
    #error "Coldfire SEC doesn't currently support AES-CCM mode"

#elif defined(WOLFSSL_IMX6_CAAM) && !defined(NO_IMX6_CAAM_AES)
    /* implemented in port/caam_aes.c */

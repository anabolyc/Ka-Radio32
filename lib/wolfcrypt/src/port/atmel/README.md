...
Requires the Microchip CryptoAuthLib library. The examples in `port/atmel/atmel.c` make calls to the `atcatls_*` API's.
...
The reference ATECC508/608A PK callback functions are located in the `port/atmel/atmel.c` file.

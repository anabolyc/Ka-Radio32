...
// SPI lcd
//---------
#define PIN_LCD_CS GPIO_NONE //CS
#define PIN_LCD_A0 GPIO_NONE //A0 or D/C
...
char* gpio_get_label(void);
char* gpio_get_comment(void);
...
bool option_get_esplay(void);
bool option_get_tas5805m(void);
